...
export default function CreateKitPage() {
  ...
  return (
    <div style={{ minHeight:'100vh', backgroundImage:'url(/assets/locker_room.jpg)', backgroundSize:'cover', backgroundPosition:'center', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'2rem', position:'relative' }}>
